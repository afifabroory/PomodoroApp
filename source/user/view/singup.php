        ...
        <div class="grid grid-cols-3 mx-auto lg:w-6/12 md:w-9/12 border border-black rounded">
            <div class="col-span-2">
                <div class="w-full my-4">
                    <div class="text-xl mx-auto w-4/5">Create your MyPomdoro Account</div>
                </div>
                <form method="POST" class="grid grid-cols-1">
                    <label class="form__record">
                        <div class="form__record-label after:content-['']">Name</div>
                        <input class="form__record-input" type="text" id="fname" name="fname" placeholder="John Doe" autofocus>
                        <div class="">Lorem ipsum dolor</div>
                    </label>
                    <label class="form__record">
                        <div class="form__record-label">Username</div>
                        <input class="form__record-input" type="text" id="usname" name="usname" placeholder="JohnDoes">
                        <div class="">Lorem ipsum dolor</div>
                    ...
                    <label class="form__record">
                        <div class="form__record-label">Email</div>
                        <input class="form__record-input" type="mail" id="email" name="email" placeholder="mail@example.com">
                        <div class="">Lorem ipsum dolor</div>
                    </label>
                    <label class="form__record">
                    ...
                    <label class="form__record">
                        <div class="form__record-label">Confirm Password</div>
                        <input class="form__record-input" type="password" id="cfpass" name="cfpass" placeholder="Retype your password">
                        <div class="">Lorem ipsum dolor</div>
                    </label>
